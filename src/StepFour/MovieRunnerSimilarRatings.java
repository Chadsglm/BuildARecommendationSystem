...
public class MovieRunnerSimilarRatings {
  ...
  public static void printSimilarRatings() {
    FourthRatings fourthRatings = new FourthRatings ("ratings"); // Change to the variable
    MovieDatabase.initialize("ratedmoviesfull"); // Change to the variable

    System.out.println("Read data for " + RaterDatabase.size() + " raters");
    System.out.println("Read data for " + MovieDatabase.size() + " movies");

    String id = "337"; // Change to the variable
    int numSimilarRaters = 10; // Change to the variable
    int minimalRaters = 3; // Change to the variable
  ...
  public static void printSimilarRatingsByGenre() {
    ...
    String genre = "Mystery"; // Change to the variable
    GenreFilter gf = new GenreFilter(genre);

    String id = "964"; // Change to the variable
    int numSimilarRaters = 20; // Change to the variable
    int minimalRaters = 5; // Change to the variable
  ...
  public static void printSimilarRatingsByDirector() {
    ...
    String id = "120"; // Change to the variable
    int numSimilarRaters = 10; // Change to the variable
    int minimalRaters = 2; // Change to the variable
    ArrayList<Rating> similarRatings = fourthRatings.getSimilarRatingsByFilter
  ...
  public static void printSimilarRatingsByGenreAndMinutes() {
    ...
    int minMin = 80; // Change to the variable
    int maxMin = 160; // Change to the variable
    ...
    String id = "168"; // Change to the variable
    int numSimilarRaters = 10; // Change to the variable
    int minimalRaters = 3; // Change to the variable
    ArrayList<Rating> similarRatings = fourthRatings.getSimilarRatingsByFilter
  ...
  public static void printSimilarRatingsByYearAfterAndMinutes() {
    ...
    int year = 1975; // Change to the variable
    YearAfterFilter yaf = new YearAfterFilter (year);

    int minMin = 70; // Change to the variable
    int maxMin = 200; // Change to the variable
    MinutesFilter mf = new MinutesFilter (minMin, maxMin);
    ...
    String id = "314"; // Change to the variable
    int numSimilarRaters = 10; // Change to the variable
    int minimalRaters = 5; // Change to the variable
    ArrayList<Rating> similarRatings = fourthRatings.getSimilarRatingsByFilter
        (id, numSimilarRaters, minimalRaters, af);
