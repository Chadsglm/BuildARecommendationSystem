...
public class FirstRatings {
  ...
  private static HashMap<String,Integer> DirectorAndMovies(ArrayList<Movie> films){
  ...
  private static HashMap<String, ArrayList<Rating>> csvLoadRaters(CSVParser parser){
  ...
  private static HashMap<String, ArrayList<Rating>> loadRaters(String filename){
...
//    System.out.println("And they were voted by the users ID: " + s);
